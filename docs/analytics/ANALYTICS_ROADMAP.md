...
> - **B4+ (agregaty lejka per kanał, 2026-07-09, prod `pneadm` `cb4d732`):** tabele `analytics_daily_*_funnels`, `order_form_attributions`, komenda `analytics:aggregate-order-forms`, cron 03:45, dashboard `Lejek formularza (kanały)`, healthcheck, backfill od 2026-06-25. **2F** na `pnedu` (`bc6deca`). Runbook: [`docs/deploy/2026-07-B4-order-form-funnel-production-deploy.md`](../deploy/2026-07-B4-order-form-funnel-production-deploy.md). Spec: [`STAGE_B4_ORDER_FORM_FUNNEL_AGGREGATES.md`](./STAGE_B4_ORDER_FORM_FUNNEL_AGGREGATES.md).
>

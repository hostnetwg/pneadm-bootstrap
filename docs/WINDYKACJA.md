...
- **wysyłka e-maila z karty sprawy**: przycisk „Wyślij przypomnienie” → modal (jak linki do prowadzącego) z szablonami przypomnienie/ponaglenie, edycją treści, **checkboxami odbiorców** (zamawiający / uczestnik / kontakty sprawy — można zaznaczyć kilku; opcjonalnie dodatkowy e-mail), wysyłką właściwą i testową, opcjonalnym PDF ze sprawy / z iFirma + upload PDF; wpis w historii `email`; VIP / `do_not_auto_dun` = ostrzeżenie, bez blokady; SMS później,

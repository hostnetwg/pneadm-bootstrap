...
- Ręczne powiązanie od strony przelewu: w modalu podglądu importu panel „Powiąż ręcznie” (`GET accounting.bank-imports.lookup-cases` — tylko niezamknięte sprawy; FV/KSeF/NIP/nazwa/e-mail/ID) + `POST .../transactions/{tx}/link-case`.

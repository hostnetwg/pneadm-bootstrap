...
Krótka historia wersji obu aplikacji jest w `CHANGELOG.md` (każde repo osobno) i w panelu ADM pod **Konto**, po linii, jako główne pozycje menu. Kanon: [`CHANGELOG_VERSIONING.md`](../CHANGELOG_VERSIONING.md).

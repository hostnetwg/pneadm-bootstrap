...
<body>
    ...
    <p>uczestniczył/a w webinarze z cyklu
<h3>TIK w pracy NAUCZYCIELA</h3></p>
    <p>zorganizowanym w dniu {{ \Carbon\Carbon::parse($course->start_date)->format('d.m.Y') }}r. w wymiarze {{ $durationMinutes }} minut, przez</p>

    <p class="bold"><span style="color: red;">"Platforma Nowoczesnej Edukacji"</span></p>
    ...
    <div class="footer">
        ...
        "Platforma Nowoczesnej Edukacji"<br>ul. Andrzeja Zamoyskiego 30/14, 09-320 Bieżuń<br>
<a href="https://nowoczesna-edukacja.pl" target="_blank">nowoczesna-edukacja.pl</a>
    </div>
</body>
</html>

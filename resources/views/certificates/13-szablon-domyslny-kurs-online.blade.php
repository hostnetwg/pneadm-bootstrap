...
<body>
    ...
    <p>ukończył/a kurs online</p>
    <p>@php
        $__eventTemplate = '{czas_trwania} przygotowanym przez';
        $__eventResolved = app(\App\Services\Certificate\CertificateTemplateVariableResolver::class)->resolveEventText(
            $__eventTemplate,
            [
                'course' => $course,
                'effective_completion_date' => $effective_completion_date ?? null,
                'duration_minutes' => (int) ($durationMinutes ?? 0),
                'show_duration' => true,
            ]
        );
        echo $__eventResolved ?? '';
    @endphp</p>

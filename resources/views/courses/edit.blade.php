                    ...
                    <div class="card-body">
                        <div class="form-check mb-3">
                            ...
                            <input type="checkbox"
                                   ...
                                   {{ old('registration_closed', $course->hasClosedRegistration()) ? 'checked' : '' }}>
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="registration_closed_message"
                                      ...
                                      rows="3"
                                      placeholder="Na ten termin nie ma już wolnych miejsc.">{{ old('registration_closed_message', $course->registration_closed_message) }}</textarea>

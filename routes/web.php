...
Route::middleware(['auth', 'check.user.status'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::delete('pnedu-users/{id}/force-delete', [PneduUsersController::class, 'forceDelete'])->name('pnedu-users.force-delete');
    ...
    Route::middleware(['auth', 'verified', 'check.user.status', 'analytics.debug.access'])
        ...
        ->group(function () {
            ...
            Route::get('/order-form-funnels', [AnalyticsOrderFormFunnelController::class, 'index'])->name('order-form-funnels.index');
            Route::get('/order-form-funnels/export/channels', [AnalyticsOrderFormFunnelController::class, 'exportChannels'])->name('order-form-funnels.export.channels');
            Route::get('/order-form-funnels/export/courses', [AnalyticsOrderFormFunnelController::class, 'exportCourses'])->name('order-form-funnels.export.courses');
            Route::get('/order-form-funnels/export/campaigns', [AnalyticsOrderFormFunnelController::class, 'exportCampaigns'])->name('order-form-funnels.export.campaigns');
            Route::get('/order-form-funnels/export/gus', [AnalyticsOrderFormFunnelController::class, 'exportGus'])->name('order-form-funnels.export.gus');
            Route::get('/order-form-funnels/export/data-quality', [AnalyticsOrderFormFunnelController::class, 'exportDataQuality'])->name('order-form-funnels.export.data-quality');
            Route::post('/order-form-funnels/recompute', [AnalyticsOrderFormFunnelController::class, 'recompute'])->name('order-form-funnels.recompute');
    ...
    Route::post('online-courses/reorder', [OnlineCoursesController::class, 'reorder'])
        ->name('online-courses.reorder');
    ...
    Route::prefix('courses/{course}/participants')->group(function () {
        ...
        Route::post('/{participant}/invalidate-live-access-token', [ParticipantController::class, 'invalidateLiveAccessToken'])->name('participants.invalidate-live-access-token'); // ClickMeeting: unieważnij token
    ...
    Route::prefix('settings')->name('settings.')->group(function () {
        ...
        Route::get('analityka', [PneduPurchasesController::class, 'analytics'])->name('analytics.index');
        Route::post('pnedu-zakupy', [PneduPurchasesController::class, 'store'])->name('pnedu-purchases.store');
        Route::get('analityka/lejek-opt-out/{scope}/{action}', [PneduPurchasesController::class, 'funnelSkipToggle'])

...
class UpdateRevenueRecordRequest extends FormRequest
{
    /**
    ...
    {
        return true; // Wszyscy zalogowani użytkownicy mogą edytować dane
    }
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            // Sprawdź unikalność year + month (z wykluczeniem aktualnego rekordu)
            $year = $this->input('year');
            $month = $this->input('month');
            $revenueRecordId = $this->route('id');

            if ($year && $month && $revenueRecordId) {

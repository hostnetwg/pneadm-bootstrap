...
return [
    ...
    'connections' => [
        ...
        // Baza frontu pnedu.pl (użytkownicy rejestrujący się na stronie) — te same host/credentials co DB_*, inna nazwa bazy
        'pnedu' => [
            'driver' => 'mysql',
            'url' => env('DB_PNEDU_URL'),
            'host' => env('DB_PNEDU_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('DB_PNEDU_PORT', env('DB_PORT', '3306')),
            'database' => env('DB_PNEDU_DATABASE', 'pnedu'),
            'username' => env('DB_PNEDU_USERNAME', env('DB_USERNAME', 'sail')),
            'password' => env('DB_PNEDU_PASSWORD', env('DB_PASSWORD', 'password')),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            ...
            'strict' => true,
            'engine' => null,
            'timezone' => env('DB_PNEDU_TIMEZONE', env('DB_TIMEZONE', '+00:00')),
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
